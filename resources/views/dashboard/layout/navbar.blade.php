{{-- navbar --}}
<nav class="border-gray-200 dark:bg-gray-900 text-white " style="background-color: rgb(60, 42, 33)">
    ...
    <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
        ...
        <ul class="py-2" aria-labelledby="user-menu-button">
            ...
            <li class="flex-1 items-center">
                <a href="{{ route('logout') }}" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white" onclick="event.preventDefault();
    ...
    <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1 text-white" id="navbar-user">

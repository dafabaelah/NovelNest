            ...
            <div class="max-w-sm mx-2 my-4 bg-white shadow-md rounded-lg overflow-hidden">
                ...
                <div class="p-4">
                    ...
                    <div class="mt-4 flex items-center justify-between">
                        <a href="{{ route('readNovel', ['id' => $n->novel->id]) }}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-block">
                            Baca Sekarang
                        </a>
                    </div>
                </div>

...
@section('container')
    <div class="flex flex-wrap justify-center">
        <div class="max-w-sm mx-2 my-4 bg-white shadow-md rounded-lg overflow-hidden relative">
            ...
            <span class="bg-blue-500 text-white flex mt-1 absolute top-2 left-2 px-2 py-1 rounded-full bg-opacity-100">#1</span>
            ...
            <div class="p-4">
                ...
                <div class="mt-4 flex items-center justify-between">
                    <button class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Lanjutkan Baca</button>
                    <button class="text-gray-300 hover:text-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium text-sm">Tambah ke Favorite</button>
                </div>
            </div>
        </div>
        <div class="max-w-sm mx-2 my-4 bg-white shadow-md rounded-lg overflow-hidden relative">
            <!-- Label Juara 1 Favorite -->
            <span class="bg-blue-500 bg-opacity-50 text-white flex mt-1 absolute top-2 left-2 px-2 py-1 rounded-full">#2</span>
        ...
        <div class="max-w-sm mx-2 my-4 bg-white shadow-md rounded-lg overflow-hidden relative">
            <!-- Label Juara 1 Favorite -->
            <span class="bg-blue-500 bg-opacity-50 text-white flex mt-1 absolute top-2 left-2 px-2 py-1 rounded-full">#3</span>
        ...
        <div class="max-w-sm mx-2 my-4 bg-white shadow-md rounded-lg overflow-hidden relative">
            <!-- Label Juara 1 Favorite -->
            <span class="bg-blue-500 bg-opacity-50 text-white flex mt-1 absolute top-2 left-2 px-2 py-1 rounded-full">#4</span>
        ...
        <div class="max-w-sm mx-2 my-4 bg-white shadow-md rounded-lg overflow-hidden relative">
            <!-- Label Juara 1 Favorite -->
            <span class="bg-blue-500 bg-opacity-50 text-white flex mt-1 absolute top-2 left-2 px-2 py-1 rounded-full">#5</span>
        ...
        <div class="max-w-sm mx-2 my-4 bg-white shadow-md rounded-lg overflow-hidden relative">
            <!-- Label Juara 1 Favorite -->
            <span class="bg-blue-500 bg-opacity-50 text-white flex mt-1 absolute top-2 left-2 px-2 py-1 rounded-full">#6</span>

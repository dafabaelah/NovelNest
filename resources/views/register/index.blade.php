...
<body class="bg-cover bg-no-repeat bg-center bg-gray-800 bg-blend-multiply" style="background-image: url('images/bg.jpeg');">
  <div class="flex items-center justify-center h-screen">
    <div class="w-full max-w-sm mx-auto p-4 bg-white items-center border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
      <form class="space-y-6" action="#">
          ...
          <div>
              ...
              <input type="text" name="fullname" id="fullname" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="fullname" required>
          </div>
          <div>
          ...
          <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
            Already have an account? <a href="/login" class="text-blue-700 hover:underline dark:text-blue-500">Login here</a>
          </div>
      </form>
    </div>
  </div>
